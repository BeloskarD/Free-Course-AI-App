        ...
        <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="max-w-3xl mx-auto">
                ...
                {intervention && intervention.priority >= 2 && (
                    <div className="mb-8 p-6 bg-blue-500/10 border border-blue-500/20 rounded-2xl relative overflow-hidden group">
                        ...
                        <div className="flex items-start gap-4 relative z-10">
                            ...
                            <div className="flex-1">
                                <h3 className="font-black text-blue-400 uppercase text-xs tracking-widest mb-1">{intervention.message?.title}</h3>
                                <p className="text-blue-200/80 text-sm font-medium">{intervention.message?.body}</p>
                            </div>
                            <button onClick={dismissIntervention} className="text-blue-500/50 hover:text-blue-500 transition-colors px-2 font-black">✕</button>
                        </div>
                    </div>
                )}
