        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
                ...
                <motion.div 
                    ...
                    exit={{ opacity: 0 }}
                    onClick={onClose}
                    className="absolute inset-0 bg-[var(--site-bg)]/80 backdrop-blur-xl"
                />
                ...
                >
                    <Surface className="h-full flex flex-col p-0 border-[var(--card-hover-border)] shadow-[var(--shadow-elite-hover)]">
                        {/* Header */}
                                                ...
                                                <div key={i} className="p-4 sm:p-6 rounded-[2rem] bg-[var(--card-bg)] border border-[var(--card-border)] hover:border-indigo-500/20 transition-all group">
                                                    <div className="flex items-start gap-4">
                                                        ...
                                                        <div className="flex-1">
                                                            <h4 className="text-sm sm:text-base font-black text-[var(--site-text)] mb-3 group-hover:text-indigo-500 transition-colors">{q.question}</h4>
